...
-- Latihan Madiri
-- Soal 1
SELECT * FROM tr_penjualan ORDER BY tanggal_transaksi DESC, qty, ASC;
-- Soal 2
SELECT * FROM pelanggann ORDER BY nama_pelanggan DESC
-- Soal 3
...
-- Latihan Mandiri
SELECT nama_produk, qty, harga, discon_persen, (qty * harga, discon_persen ) AS total_harga FROM tr_penjualan ORDER BY total_harga DESC;
